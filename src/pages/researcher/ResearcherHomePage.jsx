...
const ResearcherHomePage = () => {
  ...
  const filteredCompanies = useSelector(
    (state) => state.sliceCompanies.filterdCompanies
  );
  const companiesToDisplay =
    filteredCompanies.length > 0 ? filteredCompanies : AllCompanies;
        ...
        <Box style={{ margin: "40px" }}>
          ...
          <Paper shadow="xl" className="w-100% ">
            ...
            >
              ...
              <CiFilter
                style={{ margin: "10px", border: "1px solid  #CC0A26" }}
                size={30}
                color="#CC0A26"
              />
            </Box>
            ...
            <div className="d-flex flex-wrap justify-content-evenly  ">
              {companiesToDisplay.map((card, index) => (
                <CardForm
                  ...
                  employess_count={card.employess_count}
                  type={card.type}
                />
              ))}
            </div>
